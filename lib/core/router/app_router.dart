...
import 'package:smart_scanner/features/file_list/presentation/screens/file_detail_screen.dart';
...
final appRouterProvider = Provider<GoRouter>((ref) {
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: AppConstants.routeFileView,
        name: 'file-view',
        builder: (context, state) {
          final entry = state.extra as ScanFileEntry;
          return FileDetailScreen(entry: entry);
        },
      ),
    ],
  );
